...
import (
	...
	"github.com/devgymbr/kafka/client"
)
...
func (s *CommunicationStage) consumer_receives_messages(consumer string, expectedMessages []kafka.Message) *CommunicationStage {
	i := 0
